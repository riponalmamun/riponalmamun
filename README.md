...
```python
    def fun_fact(self):
        return "I love building data-driven \
                systems that make human \
                life easier! 🚀"
```
...
- 🤖 Building **Agentic AI Systems** with advanced reasoning capabilities
- 💬 Exploring **Large Language Models** and their applications
- 🔍 Developing **Explainable AI** solutions for real-world problems

### 🌱 Learning Journey
- 🎯 Advanced **Multimodal Systems** (Vision + Language)
- ⚙️ Production-ready **MLOps** practices
- ♻️ **Energy-Efficient ML** for sustainable AI

### 💬 Ask Me About
**Python • TensorFlow • PyTorch • Flask • Django • Machine Learning • Deep Learning • NLP • AI Research Projects • Web Development**
...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=18&duration=3000&pause=1000&color=F75C7E&center=true&vCenter=true&width=800&lines=Innovate+with+Purpose+%E2%80%A2+Learn+without+Limits;Build+Solutions+that+Matter+%E2%80%A2+Make+AI+Accessible;Think+Deep+%E2%80%A2+Code+Smart+%E2%80%A2+Impact+Lives" alt="Philosophy" />
</p>
...
<div align="center">
  ...
  > *"I believe the best AI is not the one that replaces humans,*  
...
<div align="center">
  ...
  **Open for collaborations in AI Research • ML Projects • Open Source**
